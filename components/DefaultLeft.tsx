      ...
      <div className="mt-1 p-2">
        ...
        <div className="glow-card rounded-b-sm p-2">
          <div className="glow-text text-xl">
            {/* <a className="glow-link flex flex-row p-2 cursor-pointer rounded-xs" href="/" target="_blank">
              <svg className="min-w-8 h-8" viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  
            ...
            <a className="glow-link flex flex-row p-2 cursor-pointer rounded-xs" href="/" target="_blank">
              <svg className="min-w-8 h-8" viewBox="2 2 21 21" fill="currentColor"  stroke="currentColor" strokeWidth="0"  strokeLinecap="round" strokeLinejoin="round">
            ...
            <a className="glow-link flex flex-row p-2 cursor-pointer rounded-xs" href="https://github.com/curioloop" target="_blank">
              <svg className="min-w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
