...
const Navbar = () => {
  ...
  return (
    <nav className="relative block min-h-12 py-0 px-5 shadow-md border-gray-200 bg-light-bg dark:bg-dark-bg z-10">
    <div className="xl:flex xl:max-w-6xl 2xl:max-w-7xl my-0 mx-auto ">
      ...
      <div className="flex items-stretch justify-center grow overflow-x-clip xl:mr-3 ">
        ...
        <div className="flex items-stretch justify-end ml-0">
          <div className="flex grow-0 m-0 px-3 py-4 z-999 items-center text-light-txt dark:text-dark-txt hover:text-light-hov dark:hover:text-dark-hov hover:bg-light-bg-hov dark:hover:bg-dark-bg-hov">
            <LocaleSwitch/>
          </div>
          <div className="flex grow-0 m-0 px-3 py-4 z-999 items-center text-light-txt dark:text-dark-txt hover:text-light-hov dark:hover:text-dark-hov hover:bg-light-bg-hov dark:hover:bg-dark-bg-hov">
            <ThemeSwitch/>
