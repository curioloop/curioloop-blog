...
export default function PoissonDistribution() {
  ...
  useEffect(() => {
    ...
    const curvesFromUrl: PoissonCurveConfig[] = [];
  ...
  const handleAddCurve = () => {
    ...
    setCurves([
      ...curves,
      { lambda: 3, color: nextColor, name: undefined }
    ]);
  };
            ...
            {svgDropdownOpen && (
              <div className="absolute z-10 right-0 mt-2 w-auto bg-white border border-gray-200 rounded shadow p-2 flex flex-row gap-2 justify-center items-center" style={{minWidth:155}}>
                <button
                  ...
                  onClick={() => {
                    if (svgString) {
                      downloadSvg('poisson-curves', svgString);
                    }
                ...
                <button
                  ...
                  onClick={() => {
                    if (cdfSvgString) {
                      downloadSvg('poisson-cdf-curves', cdfSvgString);
                    }
                    setSvgDropdownOpen(false);
                  }}
                >
                    ...
                    <div className="flex flex-row gap-2 justify-center items-center mt-2">
                      <button
                        ...
                        onClick={async () => {
                          ...
                          await exportSvgToPng(svgString, height * 2, height, "poisson-curves");
                      ...
                      <button
                        ...
                        onClick={async () => {
                          const height = Math.max(100, pngHeight);
                          if (cdfSvgString) {
                            await exportSvgToPng(cdfSvgString, height * 2, height, "poisson-cdf-curves");
                          }
                          setShowPngSize(false);
                        }}
                      >
